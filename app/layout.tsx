...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className="bg-[#f7f1e5]"><body className={`${petrona.variable} ${work.variable} ${mono.variable}`}><Providers>{children}</Providers></body></html>}
